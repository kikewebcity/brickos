    ...
    <div className="main-container">
      ...
      <nav className="barra-navegacion">
        ...
        >
          ...
          <li
            className={vistaActual === 'conoce-mas' ? 'active-link' : ''}
            onClick={() => {
              setVistaActual('conoce-mas');
              setMenuOpen(false);
            }}
          >
            Conoce más
      ...
      {(() => {
        ...
        if (vistaActual === 'ventaja')
          return (
            <div style={{ padding: '100px', textAlign: 'center' }}>
              <h2>SECCIÓN VENTAJA EN DESARROLLO</h2>
            </div>
          );
        if (vistaActual === 'conoce-mas')
          return (
            <div style={{ padding: '100px', textAlign: 'center' }}>
              <h2>SECCIÓN CONOCE MÁS EN DESARROLLO</h2>
            </div>
          );
            ...
            <section className="hero-slider">
              ...
              <div className="hero-slider-content">
                ...
                <button
                  ...
                  onClick={() =>
                    document
                      .querySelector('.calc-section-wrapper')
